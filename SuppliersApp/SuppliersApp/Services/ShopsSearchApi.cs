...
{
    public class ShopsSearchApi
    {
        internal async Task<ObservableCollection<clsShops>> GetShopsAsync(string search)
        {
            ...
            try
            {
                ...
                var url = Constants.BaseApiAddress + "MyApi/GetShopsBySearch?Search=" + search;
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    JArray loi = (JArray)jObject.GetValue("ShopsList");
