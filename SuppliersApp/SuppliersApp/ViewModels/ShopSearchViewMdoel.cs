...
{
    class ShopSearchViewMdoel:BaseViewModel
    {
        ...
        public ShopSearchViewMdoel(INavigation navigation)
        {
        ...
        public Command SelectedShopCmd
        {
            ...
            get
            {
                return new Command(async () =>
                {
                    ...
                    Application.Current.MainPage=new NavigationPage(new BarcodePage(SelectedShop.ShopID));
