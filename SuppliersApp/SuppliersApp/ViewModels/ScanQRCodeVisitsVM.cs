...
namespace SuppliersApp.ViewModels
{
    ...
    public class ScanQRCodeVisitsVM : BaseViewModel
    {
        ...
        public ScanQRCodeVisitsVM(INavigation navigation)
        {
        ...
        public Command SelectedShopCmd
        {
            ...
            get
            {
                return new Command(async () =>
                {
                 ...
                 //   Application.Current.MainPage = new NavigationPage(new VisitsPage(SelectedShop));
