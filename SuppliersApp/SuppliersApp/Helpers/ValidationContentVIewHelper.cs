...
namespace SuppliersApp.Helpers
{
    public static class ValidationContentVIewHelper
    {
        public static bool IsFormValid(object model, ContentView page)
        {
        ...
        private static void HideValidationFields
            (object model, ContentView page, string validationLabelSuffix = "Error")
        {
